"use strict";(()=>{var e={};e.id=875,e.ids=[875],e.modules={5142:e=>{e.exports=require("dotenv")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},5900:e=>{e.exports=require("pg")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,s){return s in t?t[s]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,s)):"function"==typeof t&&"default"===s?t:void 0}}})},6342:(e,t,s)=>{s.r(t),s.d(t,{config:()=>_,default:()=>u,routeModule:()=>T});var a={};s.r(a),s.d(a,{default:()=>E});var r=s(1802),o=s(7153),n=s(6249),i=s(6760),l=s(8243);let c=!1,d=async()=>{c||(await (0,l.qZ)(),c=!0)};async function E(e,t){try{await d();let{id:s}=e.query,a=new i.E;if("GET"===e.method){let e=await a.getConversation(s);if(!e)return t.status(404).json({error:"Conversation not found"});let r=await a.getMessages(s);return t.json({...e,messages:r})}if("DELETE"===e.method)return await a.updateConversation(s,{status:"cancelled"}),t.json({success:!0});t.status(405).json({error:"Method not allowed"})}catch(e){console.error("Conversation error:",e),t.status(500).json({error:e.message})}}let u=(0,n.l)(a,"default"),_=(0,n.l)(a,"config"),T=new r.PagesAPIRouteModule({definition:{kind:o.x.PAGES_API,page:"/api/conversations/[id]",pathname:"/api/conversations/[id]",bundlePath:"",filename:""},userland:a})},7153:(e,t)=>{var s;Object.defineProperty(t,"x",{enumerable:!0,get:function(){return s}}),function(e){e.PAGES="PAGES",e.PAGES_API="PAGES_API",e.APP_PAGE="APP_PAGE",e.APP_ROUTE="APP_ROUTE"}(s||(s={}))},1802:(e,t,s)=>{e.exports=s(145)},8243:(e,t,s)=>{s.d(t,{d_:()=>r,qZ:()=>o});var a=s(5900);s(5142).config();let r=new a.Pool({connectionString:process.env.DATABASE_URL,ssl:{rejectUnauthorized:!1},max:20,idleTimeoutMillis:3e4,connectionTimeoutMillis:1e4});r.on("error",e=>{console.error("⚠️  Database pool error:",e.message)});let o=async()=>{try{await r.query(`
